	...
	public function renderWindow() {
		...
		<div>
			...
			foreach ($imageSizes as $s) {
				...
				if( isset( $sizesSettings[$s]['hide_on'] ) && is_array($sizesSettings[$s]['hide_on']) && in_array($edit_type, $sizesSettings[$s]['hide_on']) ) {
					continue;
				}
